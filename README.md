...
- [RatedWithAI](https://ratedwithai.com) — an AI-powered accessibility scanner that tests websites against WCAG 2.2 guidelines and provides a compliance score with actionable recommendations. Scans any URL and generates detailed reports covering contrast, ARIA, headings, images, and more. ![free.svg](https://github.com/LisaDziuba/Awesome-Design-Tools/blob/master/Media/free.svg)
